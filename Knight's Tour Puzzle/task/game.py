...
def main():
    while True:
        ...
        while True:
            positions = input_checking(tuple(input("Enter the knight's starting position: ").split(" ")),
                                                   dimensions) # input("Enter the knight's starting position: ").split(" ") swap back before check
